...
public class WeatherContract {
    ...
    // device.
    /* TODO Uncomment for 4b - Adding ContentProvider to our Contract
    ...
    */
    ...
    /* TODO Uncomment for 4b - Finishing the FetchWeatherTask
    ...
    */
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //The location setting string that will be sent to openweathermap
        //as the location query.
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        //Column with the name of the location as a String
        public static final String COLUMN_CITY_NAME = "city_name";

        //Latitude and Longitude of the location stored as a float
